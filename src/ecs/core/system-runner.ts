...
export class SystemRunner {
  ...
  constructor(
    ...
    this.inventoryDebugSystem = new InventoryDebugSystem(this.inventoryManager, this.inventoryComponentStore, this.playerComponentStore);
