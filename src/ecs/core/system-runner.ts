...
export class SystemRunner {
  ...
  constructor(
    ...
    this.terminatorSystem = new TerminatorSystem(this.intentClickComponentStore, this.movimentIntentComponentStore, this.projectileShooterComponentStore);
