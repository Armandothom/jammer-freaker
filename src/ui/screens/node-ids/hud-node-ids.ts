export const HUD_NODE_IDS = {
  grenades: {
    icon: "hud.grenades.icon",
    root: "hud.grenades.root",
    text: "hud.grenades.text",
  },
  health: {
  ...
  root: "hud.root",
  weapon: {
    frame: "hud.weapon.frame",
    icon: "hud.weapon.icon",
    root: "hud.weapon.root",
  },
  weaponAmmo: {
    icon: "hud.weapon-ammo.icon",
    root: "hud.weapon-ammo.root",
    text: "hud.weapon-ammo.text",
  },
  weaponMags: {
    icon: "hud.weapon-mags.icon",
    root: "hud.weapon-mags.root",
    text: "hud.weapon-mags.text",
  },
} as const;
